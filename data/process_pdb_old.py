...
if __name__ == "__main__":
    ...
    parser.add_argument('-c', '--category', type=str, required=True,
                        help='category (phase) name: sg (single gyroid), dg (double gyroid), dd (double diamond), p (plumber\'s nightmare')
    ...
    Pdb2Pts(opt.category, opt.rand_trans,
            opt.rand_rot).gen_pts_from_pdb(pdb_path, opt.ntrans)
